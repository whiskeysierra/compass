...
class JooqValueRevisionRepository implements ValueRevisionRepository {
    ...
    private static final org.zalando.compass.infrastructure.database.model.tables.ValueRevision SELF =
    ...
    private <T> Field<T> dimensionsOf(final org.zalando.compass.infrastructure.database.model.tables.ValueRevision ref) {
