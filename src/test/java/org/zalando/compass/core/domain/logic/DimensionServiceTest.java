...
public final class DimensionServiceTest {
    ...
    public void shouldCreate() {
        unit.create(new Dimension("country", null, "=", "ISO-3166-1 alpha-2"), "Added new country dimension");
    ...
    public void shouldReadPage() {
        final Dimension country = new Dimension("country", null, "=", "ISO-3166-1 alpha-2");
        final Dimension postalCode = new Dimension("postal-code", null, "=", "Postal code");
