Feature: Delete a value
  ...
  Scenario: Delete value without dimensions
    ...
    And "PUT /keys/tax-rate/values" responds "200 OK" when requested with an array at "/values":
      | /value |
      | 0.19   |
    And "PUT /keys/feature.active/values" responds "200 OK" when requested with an array at "/values":
      | /value |
      | true   |
  ...
  Scenario: Delete value without matching dimensions should fail
    ...
    And "GET /keys/tax-rate/values?after=2006-12-31T23:59:59+01:00" responds successfully
